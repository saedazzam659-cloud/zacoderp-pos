...
export const AI_FEATURE_CATALOG = [
  { key: "accounting_ai_ask",     labelAr: "مستشار المعايير المحاسبية (سؤال وجواب)",     defaultDaily: 100, tier: "paid" },
  { key: "seo_article_gen",       labelAr: "توليد مقالات SEO (مدفوع — OpenAI)",          defaultDaily: 10,  tier: "paid" },
  { key: "seo_suggestions",       labelAr: "اقتراحات عناوين SEO",                          defaultDaily: 50,  tier: "paid" },
  { key: "report_analyzer",       labelAr: "محلل التقارير المالية بالذكاء الاصطناعي",      defaultDaily: 50,  tier: "paid" },
  { key: "chat_assistant",        labelAr: "المساعد العام داخل الشاشات",                   defaultDaily: 200, tier: "paid" },
  { key: "voice_actions",         labelAr: "أوامر صوتية للذكاء الاصطناعي",                 defaultDaily: 100, tier: "paid" },
  { key: "product_descriptions",  labelAr: "توليد أوصاف المنتجات",                          defaultDaily: 50,  tier: "paid" },
  { key: "crm_ai",                labelAr: "تحليلات CRM",                                   defaultDaily: 50,  tier: "paid" },
  { key: "support_ai",            labelAr: "مساعد الدعم الفني",                            defaultDaily: 50,  tier: "paid" },
  { key: "online_store_ai",       labelAr: "تحليلات المتجر الإلكتروني",                    defaultDaily: 50,  tier: "paid" },
  { key: "pos_ai",                labelAr: "تحليلات نقاط البيع",                            defaultDaily: 50,  tier: "paid" },
  { key: "manufacturing_ai",      labelAr: "مساعد التصنيع",                                 defaultDaily: 50,  tier: "paid" },
  { key: "hr_ai",                 labelAr: "تحليلات الموارد البشرية",                       defaultDaily: 50,  tier: "paid" },
  { key: "fixed_assets_ai",       labelAr: "تحليلات الأصول الثابتة",                        defaultDaily: 50,  tier: "paid" },
  { key: "contracting_ai",        labelAr: "تحليلات المقاولات",                             defaultDaily: 50,  tier: "paid" },
  { key: "hotel_ai",              labelAr: "تحليلات الفنادق",                               defaultDaily: 50,  tier: "paid" },
  { key: "hospital_ai",           labelAr: "تحليلات المستشفيات",                            defaultDaily: 50,  tier: "paid" },
  { key: "tax_entry_ai",          labelAr: "إدخال القيد الضريبي بالذكاء الاصطناعي",         defaultDaily: 100, tier: "paid" },
  { key: "account_suggestions",   labelAr: "اقتراح الحسابات (تحويلات/تسويات/مقبوضات/مدفوعات)", defaultDaily: 200, tier: "free" },
  { key: "data_import_ai",        labelAr: "تحليل وتعيين أعمدة الاستيراد",                  defaultDaily: 100, tier: "paid" },
] as const;
