                  ...
                  const renderCell = (col: ColDef) => {
                    switch (col.key) {
                      ...
                      case "netAfterDiscount":
                        return <td key={col.key} className="px-2 py-1 border border-slate-200 text-end font-mono text-slate-800">{fmt(Number(q.totalAmount ?? 0) - Number(q.vatAmount ?? 0))}</td>;
                      case "status":
                        return (
                          <td key={col.key} className="px-2 py-1 border border-slate-200 text-center">
