  ...
  return (
    <div className="space-y-6" dir="rtl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold flex items-center gap-2"><Users className="h-6 w-6 text-primary" />مجموعات الموردين</h1>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-muted/50 border-b">
                ...
                <th className="text-right px-4 py-3 font-semibold text-muted-foreground hidden sm:table-cell">الاسم (EN)</th>
            ...
            <tbody>
              {groups.map((g: any) => (
                <tr key={g.id} className="border-b hover:bg-muted/30 transition-colors">
                  ...
                  <td className="px-4 py-2.5 text-muted-foreground hidden sm:table-cell">{g.nameEn ?? "—"}</td>
