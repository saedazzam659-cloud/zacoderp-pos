...
export default function PaymentVoucherForm() {
  ...
  const [matchNew] = useRoute("/cash/payment-vouchers/multi/new");
  const [matchEdit, params] = useRoute("/cash/payment-vouchers/multi/:id");
  ...
  function jumpFromSearch() {
    ...
    setNavSearch("");
    navigate(`/cash/payment-vouchers/multi/${hit.id}`);
  }
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h1 className="text-lg font-bold">{(isNew ? t(`${NS}.newLong`) : t(`${NS}.editVoucher`)) + t(`${NS}.multiSuffix`, " (عمليات متعددة)")}</h1>
          ...
          {!isNew && navList.length > 0 && (
            <div className="flex items-center gap-1 rounded-md border bg-background px-1 py-0.5 print:hidden">
              <Button type="button" variant="ghost" size="sm" className="h-7 px-2 gap-1 text-xs"
                ...
                onClick={() => prevVoucher && navigate(`/cash/payment-vouchers/multi/${prevVoucher.id}`)}
              ...
              <Button type="button" variant="ghost" size="sm" className="h-7 px-2 gap-1 text-xs"
                ...
                onClick={() => nextVoucher && navigate(`/cash/payment-vouchers/multi/${nextVoucher.id}`)}
