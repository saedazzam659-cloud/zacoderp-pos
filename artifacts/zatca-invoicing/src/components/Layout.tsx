...
import {
  ...
  Gift, ReceiptText,
  Factory, Cog, ScanFace, Store, ShieldAlert, Briefcase, HardHat, Boxes, Megaphone, Puzzle, Cloud,
...
const superAdminNav: NavDef[] = [
  ...
  { nameKey: "nav.devStudio",            href: "/admin/dev-studio",         icon: Code2 },
...
const reportsSubNav: NavDef[] = [
  ...
  { nameKey: "nav.bankCashFlow",     href: "/accounting/reports/bank-cash-flow",    icon: Landmark,   permKey: "accounting_reports" },
...
const cashSubNav: NavDef[] = [
  ...
  { nameKey: "nav.paymentVouchersMulti", href: "/cash/payment-vouchers/multi/new", icon: ArrowUpCircle, permKey: "payment_vouchers" },
...
const ROUTE_MAP: Record<string, CrumbInfo> = (() => {
  const map: Record<string, CrumbInfo> = {
    ...
    "/admin/dev-studio":              { label: "nav.devStudio" },
    ...
    "/admin/windows-app-permissions": { label: "nav.windowsAppPermissions" },
