...
const S = {
  ...
  refundCard: { background: "#fff", border: "1px solid #e2e8f0", borderRadius: 14, boxShadow: "0 4px 20px rgba(15,23,42,0.06)", overflow: "hidden", display: "flex", flexDirection: "column" as const, maxHeight: "calc(100vh - 160px)" } as const,
  ...
  linesScroll: { flex: "1 1 auto", minHeight: 280, overflowY: "auto" as const, padding: "0 20px" } as const,
  ...
  pinnedFooter: { flexShrink: 0, padding: 20, borderTop: "1px solid #e2e8f0", background: "#fff" } as const,
