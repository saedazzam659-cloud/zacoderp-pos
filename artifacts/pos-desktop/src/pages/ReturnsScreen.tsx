...
const S = {
  wrap: { maxWidth: 1100, margin: "0 auto", width: "100%", height: "100%", display: "flex", flexDirection: "column" as const, minHeight: 0 } as const,
  headerRow: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12, gap: 16, flexShrink: 0 } as const,
  ...
  refundCard: { background: "#fff", border: "1px solid #e2e8f0", borderRadius: 14, boxShadow: "0 4px 20px rgba(15,23,42,0.06)", overflow: "hidden", display: "flex", flexDirection: "column" as const, flex: "1 1 auto", minHeight: 0 } as const,
  ...
  linesScroll: { flex: "1 1 auto", minHeight: 120, overflowY: "auto" as const, padding: "0 20px" } as const,
  tableLines: { width: "100%", borderCollapse: "collapse" as const } as const,
  theadSticky: { position: "sticky" as const, top: 0, background: "#f8fafc", zIndex: 1, boxShadow: "0 1px 0 #e2e8f0" } as const,
  pinnedFooter: { flexShrink: 0, padding: "12px 20px 16px", borderTop: "1px solid #e2e8f0", background: "#fff" } as const,
