...
const OPTIONS: Opt[] = [
  ...
  },
  {
    ...
    desc: "كتالوج عام بأكواد باركود ووحدات قياس ووزن — مناسب للبقالات والمتاجر العامة. يبدأ بكتالوج 50 صنف جاهز.",
  },
  {
    id: "restaurant", icon: "🍽️",
    title: "مطعم / كافيه",
    desc: "قائمة أصناف بدون باركود — برجر، شاورما، مشروبات، حلويات. يبدأ بقائمة 45 صنف جاهزة.",
  },
  {
    id: "retail", icon: "🛍️",
    title: "محل تجزئة",
    desc: "إلكترونيات، قرطاسية، إكسسوارات — كتالوج 30 صنف جاهز كنقطة انطلاق.",
  },
  {
    id: "plumbing", icon: "🔧",
    title: "أدوات صحية وسباكة",
    desc: "مواسير، خلاطات، وصلات، عدد سباكة — واجهة بيع حديثة بأعمدة كمية ووحدة وسعر.",
  },
  {
    id: "paints", icon: "🎨",
    title: "دهانات وأصباغ",
    desc: "بويات، ديكورات، فرش ورولات — واجهة بيع حديثة مناسبة لمحلات الدهانات.",
  },
  {
    id: "auto_parts", icon: "🔩",
    title: "قطع غيار سيارات",
    desc: "قطع غيار وإكسسوارات وزيوت — بحث سريع وواجهة بيع حديثة بأعمدة منظّمة.",
  },
  {
    id: "auto_workshop", icon: "🚗",
    title: "ورشة سيارات",
    desc: "خدمات صيانة وقطع غيار في فاتورة واحدة — واجهة بيع حديثة للورش.",
  },
  {
    id: "mobiles", icon: "📱",
    title: "موبايلات وإكسسوارات",
    desc: "أجهزة، شواحن، سماعات، إكسسوارات — واجهة بيع حديثة لمحلات الموبايل.",
  },
  {
    id: "general", icon: "🏷️",
    title: "محل عام",
    desc: "بدون حقول أو كتالوج إضافي — أبسط واجهة للملابس أو أي بضاعة خاصة بك.",
  },
];
