...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            zatca::zatca_save_secret,
            zatca::zatca_load_secret,
            zatca::zatca_clear_secret,
            zatca::zatca_get_onboarding,
            zatca::zatca_save_onboarding,
            zatca::zatca_chain_head,
            zatca::zatca_record_invoice,
            zatca::zatca_update_invoice_status,
            zatca::zatca_list_invoices,
            zatca::zatca_get_invoice,
            zatca::zatca_https_post,
            ...
            accounting::pos_payment_methods_list,
            accounting::pos_payment_method_create,
            accounting::pos_payment_method_update,
            accounting::pos_payment_method_delete,
            ...
            accounting::purchase_unpost,
            accounting::purchase_post,
            accounting::purchase_returns_list,
            accounting::purchase_return_get,
            accounting::purchase_return_create,
            accounting::purchase_orders_list,
            accounting::purchase_order_get,
            accounting::purchase_order_create,
            accounting::purchase_order_update,
            accounting::purchase_order_delete,
            accounting::purchase_order_set_status,
            accounting::purchase_order_convert,
            accounting::goods_receipts_list,
            accounting::goods_receipt_get,
            accounting::goods_receipt_create,
            ...
            accounting::sales_invoice_update,
            accounting::sales_invoice_delete,
            accounting::sales_invoice_unpost,
            accounting::sales_invoice_post,
            accounting::sales_invoice_set_zatca,
            accounting::quotations_list,
            accounting::quotation_get,
            accounting::quotation_create,
            accounting::quotation_update,
            accounting::quotation_delete,
            accounting::quotation_set_status,
            accounting::quotation_convert_to_invoice,
            accounting::sales_orders_list,
            accounting::sales_order_get,
            accounting::sales_order_create,
            accounting::sales_order_update,
            accounting::sales_order_delete,
            accounting::sales_order_set_status,
            accounting::sales_order_convert_to_invoice,
            ...
            accounting::journal_entry_update,
            accounting::journal_entry_post,
            ...
            accounting::supplier_groups_list,
            accounting::supplier_group_get,
            accounting::supplier_group_create,
            accounting::supplier_group_update,
            accounting::supplier_group_delete,
            accounting::supplier_settlements_list,
            accounting::supplier_settlement_get,
            accounting::supplier_settlement_create,
            accounting::supplier_settlement_update,
            accounting::supplier_settlement_post,
            accounting::supplier_settlement_unpost,
            accounting::supplier_settlement_delete,
            accounting::lc_list,
            accounting::lc_get,
            accounting::lc_create,
            accounting::lc_update,
            accounting::lc_delete,
            accounting::lc_close,
            accounting::lc_reopen,
            accounting::lc_recompute_usage,
            accounting::lc_post_funding,
            accounting::lc_expenses_list,
