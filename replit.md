...
- **Centralized Sequence Management:** Admin-only module for managing and auditing transaction document numbers with capacity tracking. Integrated into `journalEntries`, `sales-invoices`, and `purchase-invoices`.
