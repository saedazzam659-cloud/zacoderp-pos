...
- **Item Card PRO Extensions:** Enhancements including Item Variants, Bundles/Kits, Item Suppliers, AI Assist for fields, Tags & Smart Search, QR Code generation, Internal Audit Log for items, Item Image uploads, Per-Item Default Discount, Multi-Unit Pricing, Performance Analytics, Smart Stock Alerts, Bulk Label Printing, and Scan Barcode → Attach Image.
